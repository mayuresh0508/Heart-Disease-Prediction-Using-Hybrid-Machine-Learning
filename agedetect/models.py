...
class Search_Data(models.Model):
    ...
    prediction_accuracy_logisticregression = models.CharField(max_length=100, null = True, blank = True)
    prediction_accuracy_gradientboosting = models.CharField(max_length=100, null = True, blank = True)
    ...
    accuracy_output = models.FileField(null = True)
